...
insert into products (
  ...
  ('vasos-termicos-albirroja-fifa26',
   ...
   jsonb_build_array('Acero inoxidable doble pared','Tapa con sellado anti-derrame','Diseño exclusivo Albirroja FIFA 26','Set de 2 unidades','Capacidad ~500ml'),
   195000, 240000,
   18, 4,
   'edicion limitada', 'https://res.cloudinary.com/dx33kjc0l/image/upload/v1779801566/elpapustore/productos/vasos-termicos-albirroja-fifa26.jpg', 'from-red-500/20 to-black',
   true, true, 10),
  ...
  ('vasos-termicos-magang-elpapu',
   ...
   jsonb_build_array('Marca Magang','Acabado mate premium','Logo El Papu metalizado','Set negro + blanco','Doble pared al vacío'),
   220000, 270000,
   14, 3,
   'nuevo', 'https://res.cloudinary.com/dx33kjc0l/image/upload/v1779801575/elpapustore/productos/vasos-termicos-magang-elpapu.jpg', 'from-zinc-700/40 to-black',
   true, true, 20),
  ...
  ('casco-ls2-ff353-rapid-negro-mate',
   ...
   jsonb_build_array('Certificación ECE 22.06','Calota HPTT termoplástico','Pantalla con tratamiento UV/antirayas','Ventilación multipunto','Interior desmontable y lavable'),
   950000, 1150000,
   6, 2,
   'top', 'https://res.cloudinary.com/dx33kjc0l/image/upload/v1779801580/elpapustore/productos/casco-ls2-ff353-rapid-negro-mate.jpg', 'from-neutral-800/50 to-black',
   true, true, 30),
  ...
  ('placa-decorativa-brasil-elpapu',
   ...
   jsonb_build_array('Formato Mercosul Brasil','Impresión digital alta resolución','Lista para colgar','Medidas estándar 40x13cm aprox','Edición personalizada El Papu'),
   85000, 110000,
   25, 5,
   'viral', 'https://res.cloudinary.com/dx33kjc0l/image/upload/v1779801586/elpapustore/productos/placa-decorativa-brasil-elpapu.jpg', 'from-blue-500/20 to-black',
   true, false, 40),
  ...
  ('cuadro-poliptico-moto-3-piezas',
   ...
   jsonb_build_array('Set 3 piezas modulares','Impresión digital HD','Soporte rígido listo para colgar','Tema motero sunset','Ideal living, garage o cuarto'),
   250000, 320000,
   8, 2,
   null, 'https://res.cloudinary.com/dx33kjc0l/image/upload/v1779801591/elpapustore/productos/cuadro-poliptico-moto-3-piezas.jpg', 'from-orange-500/20 to-black',
   true, false, 50),
  ...
  ('cuadro-billete-100-dolares-placas-elpapu',
   ...
   jsonb_build_array('Cuadro billete 100 USD efecto holográfico','2 placas mini Paraguay y Brasil','Leyenda EL PAPU personalizada','Listo para colgar','Combo decorativo'),
   165000, 210000,
   12, 3,
   'combo', 'https://res.cloudinary.com/dx33kjc0l/image/upload/v1779801598/elpapustore/productos/cuadro-billete-100-dolares-placas-elpapu.jpg', 'from-yellow-500/20 to-black',
   true, true, 60),
  ...
  ('lanyards-elpapu-vol3-pro',
   ...
   jsonb_build_array('Poliéster reforzado','Clip metálico anti-vueltas','Estampado sublimado a todo color','Diseño El Papu Vol 3 PRO','Largo estándar ~50cm'),
   30000, null,
   45, 10,
   'merch', 'https://res.cloudinary.com/dx33kjc0l/image/upload/v1779801604/elpapustore/productos/lanyards-elpapu-vol3-pro.jpg', 'from-red-600/30 to-black',
   true, true, 70),
  ...
  ('vape-life-pod-eco-ii-candy-ice-10k',
   ...
   jsonb_build_array('Hasta 10.000 puffs por cartucho','Batería recargable + pantalla LED','Cartucho reemplazable Eco II','Sabor Candy Ice','Solo +18 — contiene nicotina'),
   145000, 180000,
   20, 5,
   'viral', 'https://res.cloudinary.com/dx33kjc0l/image/upload/v1779801610/elpapustore/productos/vape-life-pod-eco-ii-candy-ice-10k.jpg', 'from-pink-500/20 to-black',
   true, true, 80),
  ...
  ('cuadro-plan-de-ahorro-lisa-debo-ahorrar',
   ...
   jsonb_build_array('Grilla para tachar montos','Meta total 10.000.000','Diseño Lisa Simpson Debo Ahorrar','Soporte rígido listo para colgar','Regalo motivacional'),
   95000, 120000,
   22, 5,
   'viral', 'https://res.cloudinary.com/dx33kjc0l/image/upload/v1779801618/elpapustore/productos/cuadro-plan-de-ahorro-lisa-debo-ahorrar.jpg', 'from-yellow-400/25 to-black',
   true, true, 90),
  ...
  ('soporte-kojima-windshield-mount-ventosa',
   ...
   jsonb_build_array('Base ventosa TPU alta adherencia','Brazo articulado','Rotación 360°','Compatible hasta 7"','Diseño Kojima Japan'),
   95000, 120000,
   18, 4,
   null, 'https://res.cloudinary.com/dx33kjc0l/image/upload/v1779801626/elpapustore/productos/soporte-kojima-windshield-mount-ventosa.jpg', 'from-red-500/20 to-black',
   true, false, 100),
  ...
  ('soporte-kojima-cellphone-magnetic-mount',
   ...
   jsonb_build_array('Imán de neodimio reforzado','Rotación 360°','Base adhesiva 3M','Incluye 2 placas metálicas','Diseño Kojima Japan'),
   95000, 120000,
   16, 4,
   'top', 'https://res.cloudinary.com/dx33kjc0l/image/upload/v1779801636/elpapustore/productos/soporte-kojima-cellphone-magnetic-mount.jpg', 'from-red-500/20 to-black',
   true, true, 110),
  ...
  ('vonixx-blend-ceramic-carnauba-spray-wax-500ml',
   ...
   120000, 150000,
   15, 3,
   null, 'https://res.cloudinary.com/dx33kjc0l/image/upload/v1779801644/elpapustore/productos/vonixx-blend-ceramic-carnauba-spray-wax-500ml.jpg', 'from-blue-500/25 to-black',
   true, false, 120),
  ...
  ('vonixx-v-floc-shampoo-lava-autos-500ml',
   ...
   jsonb_build_array('pH neutro — no remueve ceras','Dilución hasta 1:400','Alta lubricidad','Espuma densa','Aroma a uva característico'),
   110000, 140000,
   17, 3,
   'top', 'https://res.cloudinary.com/dx33kjc0l/image/upload/v1779801653/elpapustore/productos/vonixx-v-floc-shampoo-lava-autos-500ml.jpg', 'from-purple-500/25 to-black',
   true, false, 130),
  ...
  ('cargador-auto-kojima-30w-dual-usbc-type-cx2',
   ...
   jsonb_build_array('2× USB-C 30W PD','Carcasa metálica premium','Diseño mini casi embutido','Carga rápida segura','Compatible 12V/24V'),
   85000, 110000,
   25, 5,
   'oferta', 'https://res.cloudinary.com/dx33kjc0l/image/upload/v1779801661/elpapustore/productos/cargador-auto-kojima-30w-dual-usbc-type-cx2.jpg', 'from-red-500/20 to-black',
   true, true, 140)
